...
- (void)SetUI {
    ...
    // softAPView ------------
    UIView *Softview = [[UIView alloc]
        initWithFrame:CGRectMake(0, CGRectGetMaxY(DeviceModeLabel.frame), [UIScreen mainScreen].bounds.size.width, Height * 4 + offset * 4)];
    ...
    // softAP ssid
    UITextField *SoftSsidTextField = [[UITextField alloc]
    ...
    UIView *WifiPasswordline = [[UIView alloc]
        initWithFrame:CGRectMake(0, self.WifiPasswordTextField.frame.size.height - 2, self.WifiPasswordTextField.frame.size.width, 1)];
    ...
    UIButton *btn = [[UIButton alloc]
        initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width - buttonW) / 2, CGRectGetMaxY(wifiView.frame) + offset, buttonW, Height)];
...
- (void)setDisplaymode:(OpMode)displaymode {
    ...
    switch (displaymode) {
        ...
        case OpModeSta: {
            ...
            self.wifiview.frame =
                CGRectMake(0, CGRectGetMaxY(self.softpasswordView.frame), [UIScreen mainScreen].bounds.size.width, Height * 2 + offset * 2);
